# دستورالعمل مشارکت در افزونه Buyruz Settings
...
- مقدار نسخه باید در تمام مکان‌های زیر به‌روزرسانی شود:
  - هدر فایل `buyruz-settings.php` (کلید `Version`)
...
- **ممنوعیت مطلق `alert` و `confirm`:** استفاده از پاپ‌آپ‌های مسدودکننده بومی مرورگر (`alert()` و `confirm()`) در کل افزونه و ماژول‌های آن قدغن قطعی است؛ همیشه از سیستم توست مدرن و ماژولار یا مودال‌های اختصاصی غیرمسدودکننده استفاده شود.
