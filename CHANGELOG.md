...
## [1.3.12] - 2025-11-29
- حذف کامل سیستم به‌روزرسانی از گیت‌هاب؛ اکنون افزونه فقط به صورت دستی (FTP یا بارگذاری بسته) به‌روزرسانی می‌شود.
- نمایش تاریخ «آخرین آپدیت» در فهرست افزونه‌ها بر اساس زمان آخرین تغییر فایل اصلی افزونه، بدون اتصال به سرور بیرونی.
- پاکسازی گزینه‌ها و ترنزینت‌های مربوط به آپدیت خودکار و ساده‌سازی صفحهٔ تنظیمات و مستندات برای روال به‌روزرسانی دستی.
