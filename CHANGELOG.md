...
- ستون پیش‌فرض دوم به «مخاطب/سن/نفرات» تغییر کرد و عنوان پیش‌فرض در فرانت از تنظیمات خوانده می‌شود؛ کَش رندر برای جای‌گذاری تکراری حذف شد تا جدول هم در توکن و هم انتهای محتوا دیده نشود.
