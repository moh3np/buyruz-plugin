...
## [1.3.6] - 2025-10-23
- اجرای منطق آکاردئون فقط روی درخواست‌های فرانت‌اند؛ بررسی‌های مدیریتی مثل «بررسی مجدد برای به‌روزرسانی» دیگر به کد Rank Math دستکاری‌شده نمی‌خورند.
- سازگاری بیشتر با اسکیماهای غیرمعمول با تبدیل امن اشیاء به آرایه و عبور از داده‌های ناقص.
