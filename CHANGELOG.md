...
## [2.3.47] - 2025-12-30
- هم‌ترازی ستون/سطر: هدر و تمام سطرهای داده در یک ستون زیر هم قرار گرفتند و دکمه‌های افزودن/حذف ستون به فرم برگشتند تا چیدمان دقیقاً شبیه جدول باشد.
- استایل گرید و منطق نام‌گذاری فیلدها برای چند ستون اصلاح شد تا حذف/افزودن ستون در همهٔ سطرها همگام شود و در حالت خالی خروجی نمایش داده نشود.

## [2.3.46] - 2025-12-30
- چیدمان جدول ادمین یک‌ستونه و عمودی شد: هدر در سطر اول و تمام سطرهای داده دقیقاً زیر آن قرار می‌گیرند؛ دکمه‌های ستون حذف شد و ورودی‌ها مرکزچین با کارت‌های سفید مرتب شدند.
- منطق ذخیره و رندر فرانت به یک ستون محدود شد تا جدول دقیقاً مانند فرم ادمین نمایش داده شود و در حالت خالی خروجی ندهد.
- اسکریپت ادمین ساده‌تر شد؛ فقط افزودن/حذف ردیف پشتیبانی می‌شود و نام‌گذاری فیلدها با ساختار جدید هماهنگ است.
