# یادداشت‌های تغییرات Bayruz Settings
...
## [4.0.0] - 2025-11-29
- ری‌برند کامل به Bayruz Settings: تغییر نام فایل اصلی به `bayruz-settings.php`، متن دامنه به `bayruz-settings` و نسخه 4.0.0.
