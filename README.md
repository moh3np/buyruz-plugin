# تنظیمات بایروز (Bayruz Settings)
...
## معرفی
تنظیمات بایروز (Bayruz Settings) یک هاب مرکزی برای مدیریت همهٔ ماژول‌ها و قابلیت‌های بایروز است. طراحی آن ماژولار است تا هر قابلیت (مثلاً FAQ یا ادغام‌های آینده) بتواند جداگانه اضافه یا حذف شود و پنل همچنان ساده و سریع باقی بماند.
