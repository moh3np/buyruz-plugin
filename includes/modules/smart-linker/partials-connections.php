...
<table class="form-table" role="presentation">
    <tbody>
        <tr>
            <th scope="row"><label for="brz-sl-remote-endpoint">Remote API Endpoint <span class="dashicons dashicons-editor-help" title="آدرس endpoint سایت مقابل برای API اینونتوری."></span></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="brz-sl-remote-key">Remote API Key <span class="dashicons dashicons-editor-help" title="برای احراز هویت درخواست Sync استفاده می‌شود."></span></label></th>
            <td>
